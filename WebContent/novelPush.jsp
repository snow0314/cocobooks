...
<body>
	...
	<form method="post">
		...
		<div class="titleBox">
			제목: <input type="text" value="" class="title" name="title" maxlength="20">
		</div>
		<div class="introBox">
			<div class="contentsTxt">작품 소개 250자 이내</div>
			<textarea class="area" name="contents"  maxlength="250" ></textarea>
		</div>
		<div class="footerBox">
			<div class="gradeBox">
			...
			<div class="payNfreeBox">
				<input type="submit" value="${info}등록" class="submitBtn"
					formaction="novelinsert">
			</div>
